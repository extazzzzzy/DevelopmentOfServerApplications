...
Route::middleware(['web', 'log.requests'])->group(function () {
    // Lab2
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::prefix('ref')->group(function () {
            ...
            Route::prefix('log/request')->group(function () {
                Route::get('', [LogRequestController::class, 'getCollectionLogsRequests'])->middleware('check.permission:get-list-logs-requests');
                Route::get('{id}', [LogRequestController::class, 'getLogRequest'])->middleware('check.permission:get-log-request');
                Route::delete('{id}', [LogRequestController::class, 'deleteLogRequest'])->middleware('check.permission:delete-log-request');
            });
